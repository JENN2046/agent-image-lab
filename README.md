...
```yaml
current_phase: runtime_to_review_minimal_real_loop_v1_native_doubao_delegate_module
...
current_local_capability_completed: retry_007_closed_provider_link_evidence_only_runtime_v1_guarded_skeleton_readonly_real_review_session_decision_record_draft_registry_fixture_smoke_flow_validation_gate_split_static_real_entry_viewer_and_native_doubao_delegate_module
current_local_capability_completed_lane: Green_local_delegate_module_and_exact_confirmation_preflight_no_real_provider_call
current_local_capability_next: guarded_live_probe_execution_with_bound_owner_runtime_delegate
current_local_capability_next_lane: Amber_only_with_budget_receipt_exact_confirmation_bound_owner_runtime_and_no_secret_value_read
...
recommended_next_if_continuing_local_product_work: guarded_live_probe_execution_with_bound_owner_runtime_delegate
recommended_next: runtime_to_review_minimal_real_loop_v1_guarded_live_probe_execution_with_bound_owner_runtime_delegate
```
