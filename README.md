...
- `docs/FIRST_GIT_PORTABLE_PREVIEW_CAPSULE_AUTHORIZATION_GATE.md` 是第一颗 Git-portable preview capsule 的具体授权包草案，默认样本为 `accepted_womens_resort_relaxed_knit_codex_v2_001`；它不读取源图、不创建或复制 `preview.webp`。
