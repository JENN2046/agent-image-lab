...
```yaml
current_phase: runtime_to_review_v2_formal_v11_guarded_live_activation_packet_draft_20260616
current_goal: review_inactive_formal_v11_guarded_live_activation_packet_draft
...
current_local_capability_completed: completed_validated_local_green_activation_draft_packet_status_draft_inactive_not_executed
current_local_capability_completed_lane: Green_local_inactive_formal_v11_activation_draft_no_execution_authorized
current_local_capability_next: exact-file diff review / review inactive draft; future live probe requires separate owner activation packet
current_local_capability_next_lane: Green_local_review_only_future_live_probe_requires_separate_owner_activation_packet
...
recommended_next_if_continuing_local_product_work: exact-file diff review / review inactive draft; future live probe requires separate owner activation packet
recommended_next: exact-file diff review / review inactive draft; future live probe requires separate owner activation packet
```
