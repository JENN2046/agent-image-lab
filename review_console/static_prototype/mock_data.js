window.REVIEW_CONSOLE_MOCK = {
  ...
  "reviewer_action_catalog": [
    {
      "label": "accept_contract_baseline",
      "state": "pass",
      "description": "All registry, manifest, relation, and guard statuses pass; keep review as static evidence only."
    },
    {
      "label": "inspect_manifest_failure",
      "state": "fail_closed",
      "description": "A manifest contract failure must block the product smoke flow until repaired."
    },
    {
      "label": "repair_relation_link",
      "state": "fail_closed",
      "description": "A failure capsule without a valid resolved-by accepted sample must stay visible and blocked."
    },
    {
      "label": "block_production_guard_violation",
      "state": "fail_closed",
      "description": "Any production, runtime, or memory guard violation blocks escalation."
    },
    {
      "label": "rerun_local_validator_outside_ui",
      "state": "fail_closed",
      "description": "Missing or stale contract evidence requires local validator rerun outside the UI."
    }
  ],
  "guard": {
  ...
  readonly_visual_review_mvp_seed: {
    state_id: "readonly_visual_review_mvp_state_v1_001",
    state_type: "metadata_only_readonly_visual_review_mvp_state",
    status: "draft_ready",
    display_only: true,
    source_artifact_catalog_ref: "tests/schema_examples/visual_eval_readonly_review_artifact_catalog.example.json",
    source_renderer_ref: "tests/schema_examples/visual_eval_readonly_review_corpus_renderer.example.json",
    source_console_handoff_ref: "tests/schema_examples/visual_eval_review_console_readonly_corpus_renderer_static_handoff.example.json",
    catalog_summary: {
      artifact_count: 24,
      canonical_role_count: 24,
      all_artifacts_repo_relative: true,
      validators_must_pass: true,
      canonical_roles: [
