# v10.4 A5 DoubaoGen Single Generation Rejected Asset Contract

本文定义 v10.4 A5 DoubaoGen single generation rejected asset contract。它记录 A5 生产链路中一次且仅一次 DoubaoGen 调用已经完成，但自动审片拒绝生成资产，因此后续记忆写入和交付候选归档被阻断。

```yaml
contract:
  name: v10_4_a5_doubaogen_single_generation_rejected_asset_record
  version: v10.4-a5-doubaogen-single-generation-rejected-asset-contract
  status: generation_completed_asset_rejected_memory_blocked
  record: docs/203_v10_4_a5_doubaogen_single_generation_rejected_asset_record.md
