...
| `provider_preflight` | 16 | `validate_exact_a5*`, `validate_provider*`, `validate_retry*` | Provider/A5 preflight and receipt validators; do not mix with side-effect runners. |
