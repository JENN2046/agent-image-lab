...
const imageRef = "runs/real_generation/v0_6_73_real_vcp_agent_generation_retry_007/image/doubaogen/d3155f44-cc09-4d63-8974-791bca90e8c3.png";
const expected = {
  bytes: 132372,
  sha256: "07618ba87d353770dd8913bc56ae3a7a900cb56ba08e6ae330f3165cb8c8c5f0",
  mimeType: "image/jpeg",
  format: "jpeg",
...
async function main() {
  ...
  process.stdout.write(`${JSON.stringify({
    passed: true,
    validator: "validate_retry_007_artifact_integrity",
    image_ref: imageRef,
    bytes: bytes.length,
    sha256,
