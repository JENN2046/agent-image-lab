...
function New-BaseSummary {
  ...
  return [ordered]@{
    ...
    input_reference_summary = 'Photo Studio OS first-run safe cover still-life prompt'
    output_directory_ref = '<repo>/runs/photo_studio_os_v0_7'
...
memory_delta_request:
  ...
  archive_refs:
    - "runs/photo_studio_os_v0_7/run_summary.sanitized.json"
