...
const expectedCurrentPhase = "v5.12 release candidate readiness";
...
function main() {
  ...
  const taskQueueCurrent =
    taskQueue.includes("If user authorizes v5.12 version movement") &&
  ...
  assert(checkpointCurrent, "CHECKPOINT must reflect the current v5.12 checkpoint state.");
