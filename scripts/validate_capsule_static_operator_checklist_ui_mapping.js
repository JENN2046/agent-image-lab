...
add("baseline_accepted_2", checklist.baseline.accepted === 2 && matrix.baseline.accepted === 2);
add("baseline_failure_2", checklist.baseline.failure === 2 && matrix.baseline.failure === 2);
add("baseline_total_4", checklist.baseline.total === 4 && matrix.baseline.total === 4);
