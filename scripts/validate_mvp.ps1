...
'@
  ...
  if ($LASTEXITCODE -ne 0) {
    ...
    if ($autopilotAgentBoardResumeCompactionGuard.completed_traceability_phase -ne 'amber_packet_to_receipt_traceability_v1' -or $autopilotAgentBoardResumeCompactionGuard.next_recommended_task -notin @('future_real_provider_cost_boundary_v1', 'owner_fill_or_reject_v0_3_2_live_candidate_action_packet', 'v0_3_3_first_live_generation_pilot', 'owner_authorize_or_reject_v0_3_3_execution', 'inspect_failed_provider_tool_attempt_or_authorize_new_trial') -or $autopilotAgentBoardResumeCompactionGuard.next_recommended_task_lane -ne 'Red' -or $autopilotAgentBoardResumeCompactionGuard.red_boundary_requires_authorization -ne $true) {
