...
function exitWithPreviewCapsuleMigrationPending() {
  ...
  const summary = {
    ...
    full_recoverability_count_is_currently_four: false,
...
try {
  ...
  addResult("schema_hardening_keeps_partial_legacy_rows_partial", matrixSummary.full_recoverability_count_is_currently_four === true && matrixSummary.legacy_partial_artifact_sample_count >= 3);
} catch (error) {
...
const summary = {
  ...
  full_recoverability_count_is_currently_four: matrixSummary?.full_recoverability_count_is_currently_four === true,
  artifact_recoverability_is_not_vcp_runtime_integration: true,
  vcp_runtime_integration_proven: false,
  provider_contact_performed: false,
  plugin_call_performed: false,
