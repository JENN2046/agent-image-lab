...
const attemptPath = "runs/real_generation/v0_3_3_exact_new_trial_003_shot_2/generation_attempt_result.json";
...
const reportPath = "reports/visual_asset_eval_dry_run/v0_6_29_exact_new_trial_003_shot_2_execution_closeout.json";
const passFixturePath = "tests/schema_examples/exact_new_trial_003_shot_2_execution_closeout.example.json";
const failFixturePath = "tests/schema_examples/exact_new_trial_003_shot_2_execution_closeout_fail.example.json";
const imagePath = "runs/real_generation/v0_3_3_exact_new_trial_003_shot_2/safe_adult_editorial_portrait_v1.png";
const expectedSha = "8bd7b81a916f0f6333392562d84e32368a3f28dd6a6456fc2f9e49d835a62c3b";
...
function validateRecord(record, context) {
  ...
  assert(record.attempt_id === "v0_3_3_exact_new_trial_003_shot_2", `${context}.attempt_id mismatch`);
  ...
  assert(record.review_console_bridge_ref === "review_console/live_receipt_bridge/v0_3_3_exact_new_trial_003_shot_2", `${context}.review_console_bridge_ref mismatch`);
  ...
  assert(protocol.selected_shot_id === "v0_3_3_exact_new_trial_003_shot_2", `${context}.protocol.selected_shot_id mismatch`);
  ...
  assert(record.recommended_next === "prepare_shot_3_with_exact_pre_call_payload_capture_and_immediate_path_collision_recheck_before_any_auto_promotion_or_memory_write", `${context}.recommended_next mismatch`);
}
...
function main() {
  ...
  const report = readJson(reportPath).exact_new_trial_003_shot_2_execution_closeout;
  const passFixture = readJson(passFixturePath).exact_new_trial_003_shot_2_execution_closeout;
  const failFixture = readJson(failFixturePath).exact_new_trial_003_shot_2_execution_closeout;

  assert(payload.phase === "v0_6_28_exact_new_trial_003_shot_2_pre_call_payload_capture_preflight", "payload phase mismatch");
