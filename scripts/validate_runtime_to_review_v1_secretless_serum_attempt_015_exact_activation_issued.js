...
const validator = "runtime_to_review_v1_secretless_serum_attempt_015_exact_activation_issued";
const lockPath = "reports/runtime_to_review_v1/secretless_serum_attempt_015.lock.json";
const activationIssuedPath = "reports/runtime_to_review_v1/secretless_serum_exact_activation_issued_20260604_attempt_015.json";
const validatorPath = "scripts/validate_runtime_to_review_v1_secretless_serum_attempt_015_exact_activation_issued.js";
const packageScriptName = "validate:runtime-to-review-secretless-serum-attempt-015-exact-activation-issued";
const manifestId = "runtime_to_review_secretless_serum_attempt_015_exact_activation_issued";
