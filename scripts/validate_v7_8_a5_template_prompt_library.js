...
// ── Activation form (moved to docs/a5_templates/) ──
check("activation_form_exists", () => fileExists("docs/a5_templates/a5_activation_form.md"));
check("activation_form_not_at_old_path", () => !fileExists("integrations/vcp/a5_activation_form.md"));

// ── READMEs ──
check("image_generation_readme_exists", () => fileExists("prompts/image_generation/README.md"));
check("prompt_sets_readme_exists", () => fileExists("prompts/prompt_sets/README.md"));

// ── Schemas ──
check("prompt_package_schema_exists", () => fileExists("schemas/prompt_package.schema.yaml"));
check("a5_activation_schema_exists", () => fileExists("schemas/a5_activation.schema.yaml"));
...
const summary = { passed, phase: "v7.8 Patch 01 — Prompt Library Directory Normalization", check_count: results.length, failed_count: results.filter(r => !r.passed).length, draft_only: true, no_execution: true, real_execution: false, external_network_required: false, file_write_performed: false, results };
