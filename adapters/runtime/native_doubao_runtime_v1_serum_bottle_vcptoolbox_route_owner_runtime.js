...
const moduleId = "native_doubao_runtime_v1_serum_bottle_vcptoolbox_route_owner_runtime";
...
const routeTaskId = "RUNTIME-TO-REVIEW-V1-SERUM-BOTTLE-VCPTOOLBOX-ROUTE-001";
const pipelineId = "runtime_v1_serum_bottle_vcptoolbox_route_001";
...
async function realBoundOwnerRuntimeDelegate(request, options = {}) {
  ...
  if (request.output_directory_ref !== allowedOutputDirectory) {
    return failClosed("serum_bottle_vcptoolbox_route_output_directory_not_allowed");
  }
  if (request.prompt_package_ref !== allowedPromptPackageRef) {
    return failClosed("serum_bottle_vcptoolbox_route_prompt_package_not_allowed");
  }
...
function createSecretlessProviderRuntime(options = {}) {
  return secretlessBridge.createBoundSecretlessProviderRuntimeBridge(
    ...
    {
      delegateOwner: "agent_image_lab_runtime_v1_serum_bottle_vcptoolbox_route_owner_runtime",
