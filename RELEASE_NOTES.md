...
- Added v6 Validator Quality Gate: meta-validator checking all v6 validators. `docs/archive/numbered_legacy/251_v6_validator_quality_gate.md`, `scripts/validate_v6_validator_quality_gate.js` (8 checks).
