...
- Product image A5 path 已进入 repeated quota/rate-limit stop；Native Doubao static syntax / sandbox 已硬化；v7.252 在 Route 3（继续停止生成）下完成静态审片台 mockup 准备度复核。下一步不自动重试生成，可做静态 mockup 规格门。
