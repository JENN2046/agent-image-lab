...
1. 完成 v7.226 image workflow product return gate，停止继续治理打磨并回到视觉生产系统主线。
2. 下一阶段推进 v7.227_prompt_package_builder_taskbook_gate，定义商品图 prompt package builder 的 taskbook / schema / handoff，不生成图片。
