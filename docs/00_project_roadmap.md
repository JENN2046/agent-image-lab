...
```yaml
current_phase: agent_board_resume_compaction_guard_v1
phase_status: COMPLETED_VALIDATED_LOCAL_FULL_AUTOPILOT_READY
source_phase: readiness_receipt_registry_cross_claims_v1
current_goal: verify_compact_resume_surfaces_and_surface_next_red_provider_boundary
...
evolution_next_recommended_task: future_real_provider_cost_boundary_v1
