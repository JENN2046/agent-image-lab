# v6.8 Plugin Dashboard — Legacy Index
...
These files:
- Do not authorize real plugin execution
- Do not authorize `production_candidate_002`
- Do not authorize `memory_write_path`
- Do not authorize Batch 005

If the Plugin Dashboard is revived in the future, it **must** pass a v7+ current revalidation gate.
Direct continuation from v6.8 is not permitted.
