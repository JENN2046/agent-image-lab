...
- `integrations/vcp/v0_7_real_execution_authorization_gate.md` 明确独立真实执行授权字段。
- `integrations/vcp/v0_7_photo_studio_os_dry_run_rehearsal.md` 记录 Photo Studio OS 0 调用 dry-run rehearsal。
