...
Freeze the v14.176 artifact evidence compare state as a local golden snapshot.
The snapshot prevents future UI, mock, or fixture changes from silently changing
the recoverable-vs-blocked pair, reducing the field set, dropping the lamp
blocker, or overclaiming the three-sample hard target.
