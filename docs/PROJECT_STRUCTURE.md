...
- `scripts/validators/visual_eval/` contains non-readonly visual evaluation validator implementations with root compatibility wrappers for `scripts/validate_visual_eval_*.js`.
- `scripts/validators/capsule/` contains capsule and preview validator implementations with root compatibility wrappers for `scripts/validate_capsule*.js` and `scripts/validate_preview*.js`.
