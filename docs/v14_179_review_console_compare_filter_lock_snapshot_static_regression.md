...
Freeze the v14.178 compare filter lock as a local golden snapshot. The snapshot
prevents future UI, mock, or fixture changes from unlocking the blocked lamp
candidate, changing the blocker, or claiming the third accepted sample is
complete before Jenn approval exists.
