...
Status: narrowed_by_binding_packet_refreshed_to_bcb8219a_separate_exact_activation_required
...
Required next safe action: receive separate exact activation and re-run current preflight validation before any route HTTP request. Do not retry from attempt_001.
