...
```text
v8_003_delivery_package_closeout_or_retouch_handoff_gate — 封存修图交付包，或进入人工修图交接说明；不生成新图；auto_execution_allowed=false。
```
