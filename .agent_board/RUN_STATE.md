...
```text
Agent Image Lab is in v14_008_review_console_docs_rendered_prototype_static_review_and_closeout_gate. This gate statically reviews and closes the docs-rendered Review Console prototype lane while keeping UI implementation, frontend files, HTML/CSS/JS, runtime execution, and image binary reads stopped.
```
